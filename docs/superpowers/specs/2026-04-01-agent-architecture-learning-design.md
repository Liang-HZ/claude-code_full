...
**对标源码**: `constants/prompts.ts`, `utils/claudemd.ts`, `memdir/`
...
**对标源码**: `tools/AgentTool/`, `utils/agentContext.ts`, `tasks/`
...
**对标源码**: `screens/REPL.tsx`, `ink/`, `components/`
